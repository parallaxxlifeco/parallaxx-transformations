...
|---|---|---|---|---|
| Home | `Parallaxx Home.dc.html` | `build-home-bundle.py` | `parallaxx-home-page.js` · `parallaxx-home-page` | `index.html` |
...
shadow root. See the docstring in `build-home-bundle.py` for why the step
exists at all.
