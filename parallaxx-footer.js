...
@media(max-width:560px){
  ...
  <div id="pt-foot-inner">
    ...
    <nav id="pt-util" aria-label="More">
      <!-- CONTACT REMOVED FROM THIS ROW, 1 Sep 2026. It sat directly beside
           Book a Call and both landed on the same page, so the row offered the
           reader the same destination twice under two names. Contact also has
           the coral pill in the nav on every page of the site, which is a
