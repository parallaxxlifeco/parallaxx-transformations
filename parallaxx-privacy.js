...
<section id="lg-privacy">
  ...
  <div class="lg-close">
    <div class="lg-wrap"><div class="lg-col">
      <p class="lg-label">Exercising a right</p>
      <h2>Ask, and it gets handled.</h2>
      <p>To request a copy of your data, correct it, or have it erased, write to <a href="mailto:daniel@parallaxxtransformations.com">daniel@parallaxxtransformations.com</a>. It comes to Daniel&rsquo;s own inbox.</p>
      <nav class="lg-other" aria-label="More">
        <a href="https://www.parallaxxtransformations.com/terms-of-use">Terms of Use</a>
