/* PARALLAXX TRANSFORMATIONS - Privacy Policy. Custom Element. Tag: parallaxx-privacy.
...
(function(){
  if (customElements.get('parallaxx-privacy')) return;
  ...
  /* CLOSING -- A LINE OF SUBTEXT, NOT A SECTION.
     It carried a gold label, a headline and two pill links, which gave the
     least important thing on the page the loudest treatment on it: a call
     to action at the end of a document nobody reads for pleasure.

     One small line now, with the padding down to match, so it reads as a
     footnote to the policy rather than a new section after it. The pills
     went with it -- each page's header already cross-links to the other,
     and the site footer carries both. */
  .lg-close{background:var(--navy-ink);padding:clamp(24px,3vw,34px) 0}
  .lg-sub{color:var(--label);font-size:.82rem;line-height:1.65;max-width:64ch}
  .lg-sub a{color:var(--slate);text-decoration:underline;text-underline-offset:3px;
    text-decoration-color:rgba(255,80,31,.55);transition:color .25s}
  .lg-sub a:hover{color:var(--cream);text-decoration-color:var(--coral)}
  .lg-sub a:focus-visible{outline:2px solid var(--gold);outline-offset:3px}
...
<section id="lg-privacy">

  <div class="lg-head">
    <div class="lg-wrap"><div class="lg-col">
      <p class="lg-label lg-up">Legal</p>
      <h1 class="lg-serif lg-up" style="animation-delay:.08s">Privacy Policy</h1>
      <div class="lg-meta lg-up" style="animation-delay:.16s">
        <span class="date">Last updated 1 September 2026</span>
        <span class="who">Parallax Life Co Pty LTD, trading as Parallaxx Transformations</span>
      </div>
      <p class="lg-jump lg-up" style="animation-delay:.24s">Looking for the <a href="https://www.parallaxxtransformations.com/terms-of-use">Terms of Use</a> instead?</p>
    </div></div>
  </div>
  ...
  <div class="lg-doc">
    <div class="lg-wrap"><div class="lg-col"><div class="prose">
      ...
      <ul>
        <li><strong>Personal Information:</strong> This includes any information that can be used to identify you such as your name, address, email address, phone number, and billing information.</li>
      ...
      <p>The two self-assessment tools on this site, the Priority Audit and the Archetype Quiz, hold your answers in your browser&rsquo;s memory for as long as the page is open. Nothing is saved, and nothing is sent to us.</p>
      ...
      <ul>
        ...
        <li>To send administrative information, for example, information regarding the website and changes to our terms, conditions, and policies.</li>
        <li>To respond to your inquiries and provide customer service.</li>
        <li>For our business purposes, such as data analysis, identifying usage trends, and to evaluate and improve our website, products, marketing, and your experience.</li>
      </ul>
      ...
      <!-- ADDED 1 Sep 2026. PENDING LEGAL REVIEW. -->
      <h2>Service providers we use</h2>
      <p>Your information may be held or handled by the following providers:</p>
      <ul>
        <li><strong>Cloudflare</strong> &mdash; website hosting and delivery.</li>
        <li><strong>GoHighLevel (LeadConnector)</strong> &mdash; application forms, enquiry records and marketing email.</li>
        <li><strong>Stripe</strong> &mdash; payment processing. Card details are given to Stripe and are never held by us.</li>
        <li><strong>Teachable</strong> &mdash; course and programme materials, for people enrolled in them.</li>
        <li><strong>Namecheap PrivateEmail</strong> &mdash; our email.</li>
        <li><strong>Google</strong> &mdash; fonts and video embeds, as described above.</li>
      </ul>

      <!-- ADDED 1 Sep 2026. Written to match what actually happens rather than
           to state a period nobody follows. PENDING LEGAL REVIEW. -->
      <h2>How long we keep your information</h2>
      <p>We keep enquiry and client records for as long as we may need them, and as a small business we have not routinely deleted them. If you would like your information removed, ask us and we will delete it.</p>

      <h2>Where your information is held</h2>
      <p>Parallaxx is an Australian business. Several of the providers listed above store information outside Australia, including in the United States and the European Union. Where information about people in the European Economic Area or the United Kingdom is transferred outside those areas, we rely on the transfer safeguards those providers have in place.</p>

      <h2>Your Rights</h2>
      <p>Under the GDPR, you have certain rights in relation to your personal data:</p>
      <ul>
      ...
      <p>Under Australian Privacy Law, you also have the right to access and correct your personal information, and to complain if you believe your privacy has been breached.</p>

      <!-- ADDED 1 Sep 2026. PENDING LEGAL REVIEW. -->
      <h2>Making a request or a complaint</h2>
      <p>To ask for a copy of your information, to have it corrected, or to have it deleted, contact <a href="mailto:daniel@parallaxxtransformations.com">daniel@parallaxxtransformations.com</a>.</p>
      <p>If you are not satisfied with how we have handled your information, you can complain to the Office of the Australian Information Commissioner at oaic.gov.au. If you are in the European Economic Area or the United Kingdom, you can complain to your local data protection authority.</p>

      <h2>Data Security</h2>
      <p>We are committed to ensuring the security of the information we hold about you. We take all reasonable steps to protect your personal information from misuse, interference, and loss, and from unauthorized access, modification, or disclosure. However, no method of transmission over the internet or method of electronic storage is 100% secure, therefore, we cannot guarantee its absolute security.</p>
  ...
  <div class="lg-close">
    <div class="lg-wrap"><div class="lg-col">
      <p class="lg-sub">To request a copy of your information, change, update or request it to be removed please contact <a href="mailto:daniel@parallaxxtransformations.com">daniel@parallaxxtransformations.com</a></p>
    </div></div>
  </div>
...
/* ================================================================
  ...
  class ParallaxxPrivacy extends HTMLElement {
    connectedCallback(){
  ...
  customElements.define('parallaxx-privacy', ParallaxxPrivacy);
})();
