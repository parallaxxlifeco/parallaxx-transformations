...
(function () {
  ...
  :root {
    ...
    --trw-border:     #1E3347;
    --trw-gold:       #D4B84A;
    --trw-gold-light: #E8CF72;
    --trw-gold-dark:  #A8912E;
    --trw-orange:     #E8451C;
    --trw-orange-dk:  #C43715;
    --trw-white:      #ffffff;
    --trw-cream:      #F0EDE6;
    --trw-muted:      #5A7A96;
    --trw-text:       #8AADCA;
    --trw-head:       'Montserrat', system-ui, sans-serif;
    --trw-body:       'Poppins', system-ui, sans-serif;
  }
  ...
  #trw-page .btn--gold { background: var(--trw-orange); color: var(--trw-white); }
  #trw-page .btn--gold:hover {
    background: var(--trw-orange-dk);
    transform: translateY(-2px);
    box-shadow: 0 10px 32px rgba(232,69,28,0.35);
  }
  #trw-page .btn--outline {
    background: transparent;
    color: var(--trw-orange);
    border: 1px solid var(--trw-orange);
  }
  #trw-page .btn--outline:hover { background: var(--trw-orange); color: var(--trw-white); }
  ...
  #trw-page #hero h1 {
    ...
    font-weight: 800; color: var(--trw-white);
  ...
  #trw-page .archetype-num {
    font-family: var(--trw-head); font-size: 32px; font-weight: 700;
  ...
  #trw-page .value-card h3 { font-size: 13px; letter-spacing: 0.2em; text-transform: uppercase; color: var(--trw-gold); margin-bottom: 16px; }
  ...
  #trw-page .price-amount { font-family: var(--trw-head); font-size: 80px; font-weight: 700; color: var(--trw-white); line-height: 1; }
  ...
  #trw-page .bonus-left .title { font-family: var(--trw-head); font-size: 20px; font-weight: 700; color: var(--trw-black); line-height: 1.2; }
  ...
  /* MODAL */
  #trw-apply-modal { display: none; position: fixed; inset: 0; z-index: 9999; align-items: center; justify-content: center; padding: 20px; }
  ...
  #trw-apply-modal .modal-header {
    display: flex; justify-content: space-between; align-items: center;
    padding: 20px 28px; border-bottom: 1px solid var(--trw-border);
    position: sticky; top: 0; background: var(--trw-card); z-index: 2;
  }
...
<section id="hero">
  <div class="hero-inner">
    ...
    <p class="cta-secondary">Free to attend. &euro;59 a month if you stay. Or <a href="https://www.parallaxxtransformations.com/priority-audit" target="_top">take the Priority Audit</a> first.</p>
    ...
    <div class="video-wrap video-wrap--landscape anim anim-d1" style="margin-top:40px;">
      ...
      <button class="video-play-overlay" id="trw-vsl-play" type="button" aria-label="Play video">
        <svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <circle cx="48" cy="48" r="46" fill="rgba(6,25,56,0.85)" stroke="#D4B84A" stroke-width="2"/>
          <polygon points="40,30 68,48 40,66" fill="#D4B84A"/>
        </svg>
      </button>
    </div>
  ...
  <div class="container-wide">
    ...
    <div class="faq-wrap">
      ...
      <div class="faq-item anim">
        ...
        <div class="faq-body"><div class="faq-body-inner"><p>Because someone has to run it, and if it were another woman like you, you'd find a way to help inside ten minutes. Nothing to prove, nobody to be careful with. I've got the room.</p></div></div>
      </div>
      <div class="faq-item anim">
        <button class="faq-btn" type="button">
      ...
      <div class="faq-item anim">
        <button class="faq-btn" type="button">
          <span class="faq-q">Online or in person?</span>
          <span class="faq-ico">+</span>
        </button>
        <div class="faq-body"><div class="faq-body-inner"><p>Both, depending on where you are. Tell us your preference on the form.</p></div></div>
      </div>
      <div class="faq-item anim">
        <button class="faq-btn" type="button">
        ...
        <div class="faq-body"><div class="faq-body-inner"><p>No. But if you're already planning around not being there, it may not be the right fit.</p></div></div>
      </div>
      <div class="faq-item anim">
        <button class="faq-btn" type="button">
        ...
        <div class="faq-body"><div class="faq-body-inner"><p>Two sitting times for global coverage, and we stay fluid with what the group asks for. Come to the open session and we'll find yours.</p></div></div>
      </div>
      <div class="faq-item anim">
        <button class="faq-btn" type="button">
...
<section id="cta-final">
  <div class="container">
    ...
    <p class="cta-secondary anim anim-d3">Not ready? <a href="https://www.parallaxxtransformations.com/priority-audit" target="_top">Take the Priority Audit</a>. Ten minutes, and you'll see where you're actually spending yourself.</p>
  </div>
</section>
...
<div id="trw-apply-modal" role="dialog" aria-modal="true" aria-label="Application Form">
  ...
  function addHead() {
    ...
    once('trw-font0', function () { var l = document.createElement('link'); l.rel = 'stylesheet'; l.href = 'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,600;0,700;0,800;1,400&family=Poppins:wght@300;400;600&display=swap'; return l; });
