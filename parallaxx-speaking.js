...
<!-- ══════════════════════════════════════════════════════════════
     ...
     It used to carry an aside underneath sending anyone who arrived
     for themselves rather than for an event over to the two doors.
     Removed 25 Aug, along with the same block on the Contact page:
     the footer already carries both doors on every page of the site,
     so it was a third route to somewhere the reader could already
     get, sitting on the one block that should say a single thing.
     ══════════════════════════════════════════════════════════════ -->
<section id="sp-close">
  <div class="sp-wrap"><div class="grid">
